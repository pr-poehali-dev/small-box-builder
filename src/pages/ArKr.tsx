    ...
    <div className="min-h-screen bg-white font-ibm">
      ...
      <section id="expertise" className="py-24 bg-evraz-light px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10">
            <p className="font-ibm text-xs text-evraz-gray uppercase tracking-widest mb-4">
              Образцы документов — скачать и оценить
            </p>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <a
                  ...
                  className="flex items-center gap-4 border border-evraz-border bg-white p-5 hover:border-evraz-red hover:bg-evraz-red/5 transition-colors group"
                >
      ...
      <section id="params" className="py-24 bg-white px-6">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            <p className="font-ibm text-xs text-evraz-red uppercase tracking-widest mb-3">
              Технические параметры
