...
export const PARTNERS = [
  {
    ...
    region: "Москва и МО",
    projects: 31,
    services: ["Проектирование", "Монтаж"],
    review: {
      text: "Работы выполнены в соответствии с нормами и условиями договора, с надлежащим качеством и в установленный срок.",
      fullText:
        "Работы были выполнены в соответствии с действующими строительными нормами и правилами, согласно техническому заданию и условиям договора, с надлежащим качеством и в установленный срок.",
      author: "Заярный Г.А., генеральный директор ООО «ОБЛПРОЕКТ МОНТАЖ»",
    },
  },
  {
    slug: "delta-t",
    ...
    services: ["Монтаж"],
    review: {
      text: "Рекомендую услуги «Дельта-Т» — работа была выполнена на высоком уровне.",
      fullText:
        "Я рекомендую услуги «Дельта-Т» и могу с уверенностью сказать, что работа была выполнена на высоком уровне.",
      author: "Котельников В.П., генеральный директор АО «Прииск Усть-Кара»",
    },
  },
  {
    slug: "tyumenprom",
    name: "ООО «ТЮМЕНЬПРОМ-МОНТАЖ»",
    region: "г. Тюмень",
    projects: 19,
    services: ["Монтаж"],
    review: {
      text: "Компания проявила себя как профессиональный партнёр, способный выполнять работы в установленные сроки и надлежащего качества.",
      fullText:
        "За период сотрудничества компания ООО «ТюменьПромМонтаж» проявила себя как профессиональный партнёр, способный выполнять работы в установленные сроки и надлежащего качества.",
      author: "Артановский В.В., генеральный директор АО «КСМ»",
    },
  },
  {
    slug: "yugsnab",
    ...
    services: ["Проектирование", "Монтаж"],
    review: {
      text: "Слаженность действий и компетентность сотрудников компании заслуживают высокой оценки.",
      fullText:
        "Слаженность действий и компетентность сотрудников компании заслуживают высокой оценки.",
      author: "ИП Хабибулин Р.М.",
    },
  },
  {
    slug: "nevatehnokom",
    name: "ООО «НЕВАТЕХНОКОМ»",
    region: "г. Санкт-Петербург",
    projects: 33,
    services: ["Проектирование", "Монтаж"],
    review: {
      text: "Компания выполнила все виды работ на высоком профессиональном уровне, качественно, в срок, замечаний нет.",
      fullText:
        "Все виды работ, предусмотренные договором, компания «Неватехноком» выполнила на высоком профессиональном уровне, качественно, в срок, замечаний нет.",
      author: "Сомкин А.С., генеральный директор ООО «Петросервис»",
    },
  },
  {
    slug: "planeta",
    ...
    services: ["Монтаж"],
    review: {
      text: "Все договорные обязательства по проектированию, поставке и монтажу металлоконструкций были выполнены.",
      fullText:
        "Все договорные обязательства по проектированию, получению разрешений, изготовлению, поставке и монтажу металлоконструкций, для производственных цехов, были выполнены.",
      author:
        "Зиннуров Т.Т., зам. генерального директора по производству — главный инженер ООО «БашНефтеСервис»",
    },
  },
];
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div>
              ...
              <p className="font-ibm text-evraz-gray mt-4 max-w-xl text-base leading-relaxed">
                EVRAZ STEEL BOX реализуется проекты совместно с партнерами по
                всей России. Мы готовы подобрать партнера проектировщика и
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
            <AnimSection>
              ...
              <p className="font-ibm text-evraz-gray leading-relaxed mb-8">
                Мы предлагаем здания с высокой степенью заводской готовности,
                это позволяет нашим клиентам значительно сократить сроки
                строительства. EVRAZ STEEL BOX входит в состав ЕВРАЗа —
                вертикально-интегрированной металлургической компании, лидера на
                рынке стального проката и готовых решений для инфраструктурных
                проектов.
              </p>
              <button
            ...
            <AnimSection>
              <div className="grid grid-cols-2 gap-px bg-evraz-border border border-evraz-border">
                {[
                  ...
                  {
                    n: "30 дней",
                    l: "производство и поставка серийных зданий",
                  },
